    ...
    <div class="container py-12 px-4">
      <div class="flex mx-auto w-full text-black flex-wrap">
        ...
        <div class="lg:w-7/12 w-full">
          ...
          <p><a :href="getPdfUrl()" download="resume.pdf"
              class="inline-block px-6 py-3 text-black rounded-lg shadow-md hover:bg-[#212529] hover:text-white">{{
                i18n.t("resume") }}</a>
          </p>
        </div>
      </div>
...
import {getPdfUrl} from "@/utils/pathResolver";
